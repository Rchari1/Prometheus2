...
class AvailablePlanets:
    def __init__(self):
        ...
        WASP17a = Star(1.38 * const.R_sun, 1.20 * const.M_sun, 6550., 4.23, -0.25, 0.)
        # Anderson et al. 2010, The Astrophysical Journal, 709:159–167

        WASP17b = Planet('WASP-17b', 1.74 * const.R_J, 0.49 * const.M_J, 0.0501 * const.AU, hostStar = WASP17a)
        # Anderson et al. 2010, The Astrophysical Journal, 709:159–167

        WASP107a = Star(0.66 * const.R_sun, 0.69* const.M_sun, 4425., 4.63, -0.02, 0.)
        #WASP107a = Star(0.66 * const.R_sun, 0.69 * const.M_sun, 4425., 4.637, -0.25, 0.) 
        # Anderson et al. 2017, A&A 604, A110 (Mocnik 2017 - Piaulet 2021)

        WASP107b = Planet('WASP-107b', 0.94 * const.R_J, 0.0960 * const.M_J, 0.055 * const.AU, hostStar = WASP107a)
        # Anderson et al. 2017, A&A 604, A110

        L9859a = Star(0.313 * const.R_sun, 0.312 * const.M_sun, 3367., 4.85, 0.0, 0.)  # Example values based on low-mass stars
        # Reference: Exoplanet Archive + Example radius/mass, temperature for an M dwarf
    
        L9859b = Planet('L98-59b', 0.0758 * const.R_J, 0.0013 * const.M_J, 0.02191 * const.AU, hostStar = L9859a)
        # Planetary parameters based on provided values


        self.planetList = [WASP49b, HD189733b, Cancri55e, WASP39b, WASP17b, WASP107b, L9859b]
